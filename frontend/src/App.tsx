      ...
      <div className={`lg:pl-72 flex flex-col h-screen`}>
            ...
            {messages.length === 0 && (
              ...
              >
                ...
                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">
                  Hello! I'm your Multimodal AI (Note: Sometimes the first response is slow because of Hosting platform waking up)
                </h2>
        ...
        <div className={`border-t ${
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-2 text-center">
            AI can make mistakes – double-check important info. Images up to 20MB (Note: Sometimes the first response is slow because of Hosting platform waking up.)
          </p>
        </div>
      </div>
    </div>
